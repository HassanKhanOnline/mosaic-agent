...
async function countByStatus(sb: ReturnType<typeof db>) {
  ...
  return {
    ...(Object.fromEntries(entries) as Record<(typeof statuses)[number], number>),
    threads: threads ?? 0,
  }
}
